...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see me.showfun.service.impl.PasswordTokenManager#generateRecoveryToken(me.showfun.model.User)
     */
    @Override
    ...
    /**
     * @see me.showfun.service.impl.PasswordTokenManager#isRecoveryTokenValid(me.showfun.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see me.showfun.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
