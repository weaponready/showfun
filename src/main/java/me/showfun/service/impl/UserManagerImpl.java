...
import me.showfun.service.MailEngine;
import me.showfun.service.UserExistsException;
import me.showfun.service.UserManager;
import me.showfun.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "me.showfun.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see me.showfun.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
